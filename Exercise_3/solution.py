...
# Turn a logifle into a list of dictionaries
# one function: logtolist
# one argument is given -> the name of the file
# returns a list of dictionaries, each should have the following keys:
# ip_address : containing the IP address
# timestamp : containing the timestamp
# request : containing the HTTP request
# the dimension of the list is 206 dictionaries, each with these three key-values pairs.
